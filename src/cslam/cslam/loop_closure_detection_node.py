    ...
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[('frontend.similarity_threshold', 0.9),
                        ...
                        ('frontend.anyloc.server_address', 'tcp://localhost:5555'),
                        ('frontend.anyloc.timeout_ms', 5000),
        ...
        self.params["frontend.anyloc.server_address"] = self.get_parameter(
            'frontend.anyloc.server_address').value
        self.params["frontend.anyloc.timeout_ms"] = self.get_parameter(
            'frontend.anyloc.timeout_ms').value
        self.params["frontend.cosplace_server.server_address"] = self.get_parameter(
            'frontend.cosplace_server.server_address').value
        self.params["frontend.cosplace_server.timeout_ms"] = self.get_parameter(
            'frontend.cosplace_server.timeout_ms').value
