...
def launch_setup(context, *args, **kwargs):
    ...
    sensor_base_frame_id = LaunchConfiguration('sensor_base_frame_id').perform(context)
    map_manager_params = {
        "robot_id": LaunchConfiguration('robot_id'),
        "max_nb_robots": LaunchConfiguration('max_nb_robots'),
    }
    if sensor_base_frame_id:
        map_manager_params["frontend.sensor_base_frame_id"] = sensor_base_frame_id
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('log_level',
                              default_value='error',
                              description=''),
        DeclareLaunchArgument('sensor_base_frame_id',
                              default_value='',
                              description='Override sensor_base_frame_id in YAML (empty = use YAML value)'),
